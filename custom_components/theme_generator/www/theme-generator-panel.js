...
class ThemeGeneratorPanel extends HTMLElement {
  ...
  renderEditorView() {
    return `
      <section class="editor-split-view">
        <div class="editor-code-pane">
          <div class="editor-pane-head">
            <div>
              <strong>Theme-Code</strong>
              <span>${this.selectedFile ? this.escape(this.selectedFile) : "Geladenes Theme"}</span>
            </div>
          </div>
        ...
        <div class="editor-preview-pane">
          <div class="editor-pane-head">
            <div>
              ...
              <span>Vorschau basiert auf dem aktuell geladenen Theme-Code</span>
            </div>
          </div>
  ...
  render() {
    ...
    this.shadowRoot.innerHTML = `
      <style>
        ...
        /* v1.15.2 - linke Gruppen sauber trennen */
        .left-panel,
        .settings-panel,
        .controls-panel,
        .color-panel {
        ...
        /* v1.15.2 - Vollbreite Vorschau, Farbfelder im Vorschaufenster */
        .workbench,
        .editor-layout,
        .main-layout,
        .content-grid,
        ...
        /* v1.15.2 - Filter fuer Alle Settings */
        .settings-filter-row {
          display: flex;
          flex-wrap: wrap;
          gap: 8px;
        ...
        /* v1.15.2 - einklappbares linkes Settings-Menü */
        .settings-parent {
        ...
        /* v1.15.2 - Menü dezenter + Übersicht aufgeräumt */
        ...
        /* v1.15.2 - Vorschau-Raster repariert */
        .ha-content.clean-preview {
        ...
        /* v1.15.2 - Farbkarten und Vorschau sauber ausrichten */
        ...
        /* v1.15.2 - Menütext vollständig anzeigen */
        .ha-side {
        ...
        /* v1.15.2 - Mushroom/Bubble/card-mod sauber gruppieren */
        ...
        /* v1.15.2 - Farbformat Auswahl und Alpha nur bei Farben */
        .format-row {
          display: flex;
          gap: 8px;
          align-items: center;
        ...
        /* v1.15.2 - Demo Buttons Vorschauseite */
        .demo-preview-page {
        ...
        /* v1.15.2 - Demo Buttons im HA Vorschaufenster und mit Themefarben */
        ...
        /* v1.15.2 - Eigene Demo-Seite mit gespeicherter YAML */
        ...
        /* v1.15.2 - Demo Seite als echtes Home-Assistant iframe */
        .demo-iframe-shell {
          width: min(100%, 1240px);
          margin: 0 auto;
          padding: 28px;
        ...
        /* v1.15.2 - iframe Demo Seite ohne Home Assistant Seitenmenü */
        .demo-iframe-frame {
          position: relative;
          height: 720px;
          border-radius: 20px;
        ...
        /* v1.15.2 - Editor links, Live-Vorschau rechts */
        .editor-split-view {
          display: grid;
        ...
        /* v1.15.2 - View Tabs immer nebeneinander */
        .view-switch {
          display: inline-flex;
          flex-direction: row;
          align-items: center;
        ...
        /* v1.15.2 - card-mod / CSS Codekarten */
        .code-field-card {
          align-items: stretch;
        }
        ...
        /* v1.15.2 - View Tabs immer in einer Zeile */
        .view-switch {
          display: inline-flex;
          flex-direction: row;
          align-items: center;
      ...
      <div class="card">
        <div class="header">
          ...
          <div class="header-main">
            <div class="title-row">
              <h1>Theme Generator <span class="version-pill">v1.15.2</span></h1>
            </div>
