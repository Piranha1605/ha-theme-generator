  ...
  render() {
    ...
    this.shadowRoot.innerHTML = `
      <style>
        ...
        /* v1.16.9 - linke Gruppen sauber trennen */
        .left-panel,
        .settings-panel,
        .controls-panel,
        .color-panel {
        ...
        /* v1.16.9 - Vollbreite Vorschau, Farbfelder im Vorschaufenster */
        .workbench,
        .editor-layout,
        .main-layout,
        .content-grid,
        ...
        /* v1.16.9 - Filter fuer Alle Settings */
        .settings-filter-row {
          display: flex;
          flex-wrap: wrap;
          gap: 8px;
        ...
        /* v1.16.9 - einklappbares linkes Settings-Menü */
        .settings-parent {
        ...
        /* v1.16.9 - Menü dezenter + Übersicht aufgeräumt */
        ...
        /* v1.16.9 - Vorschau-Raster repariert */
        .ha-content.clean-preview {
        ...
        /* v1.16.9 - Farbkarten und Vorschau sauber ausrichten */
        ...
        /* v1.16.9 - Menütext vollständig anzeigen */
        .ha-side {
        ...
        /* v1.16.9 - Mushroom/Bubble/card-mod sauber gruppieren */
        ...
        /* v1.16.9 - Farbformat Auswahl und Alpha nur bei Farben */
        .format-row {
          display: flex;
          gap: 8px;
          align-items: center;
        ...
        /* v1.16.9 - Demo Buttons Vorschauseite */
        .demo-preview-page {
        ...
        /* v1.16.9 - Demo Buttons im HA Vorschaufenster und mit Themefarben */
        ...
        /* v1.16.9 - Eigene Demo-Seite mit gespeicherter YAML */
        ...
        /* v1.16.9 - Demo Seite als echtes Home-Assistant iframe */
        .demo-iframe-shell {
          width: min(100%, 1240px);
          margin: 0 auto;
          padding: 28px;
        ...
        /* v1.16.9 - iframe Demo Seite ohne Home Assistant Seitenmenü */
        .demo-iframe-frame {
          position: relative;
          height: 720px;
          border-radius: 20px;
        ...
        /* v1.16.9 - Editor links, Live-Vorschau rechts */
        .editor-split-view {
          display: grid;
        ...
        /* v1.16.9 - View Tabs immer nebeneinander */
        .view-switch {
          display: inline-flex;
          flex-direction: row;
          align-items: center;
        ...
        /* v1.16.9 - card-mod / CSS Codekarten */
        .code-field-card {
          align-items: stretch;
        }
        ...
        /* v1.16.9 - View Tabs immer in einer Zeile */
        .view-switch {
          display: inline-flex;
          flex-direction: row;
          align-items: center;
        ...
        /* v1.16.9 - Editor ohne Live-Vorschau */
        ...
        /* v1.16.9 - Hintergrundbild Schalter + Deckkraft */
        .generator-bg-layer {
          position: fixed;
          inset: 0;
          pointer-events: none;
        ...
        /* v1.16.9 - Bild/Deckkraft in HA-Topbar */
        ...
        /* v1.16.9 - festes Bild direkt in der Vorschaufläche */
        .preview-bg-image-on {
          position: relative;
          overflow: hidden;
          background-image:
        ...
        /* v1.16.9 - alter globaler Background-Layer aus */
        .generator-bg-layer {
          display: none !important;
        }
        ...
        /* v1.16.9 - echtes Bild direkt in der HA-Vorschau */
        .ha-main {
          position: relative;
          overflow: hidden;
          isolation: isolate;
        ...
        /* v1.16.9 - alter Generator Background Layer deaktiviert */
        .generator-bg-layer {
          display: none !important;
        }
        ...
        /* v1.16.9 - Einstellungsseiten bleiben ohne Bild für Schattenprüfung */
...
<span class="version-pill">v1.16.9</span></h1>
            </div>
