...
const HATG_CARDMOD_TEMPLATES = [
  {
    ...
    desc: "Icons bekommen einen runden, halbtransparenten Chip in der Akzentfarbe. Deckt ab: native HA-Karten und Mushroom (state-badge/.icon) sowie Bubble Card auf allen Ebenen - Hauptsymbol, Button-Icon, Sub-Button-Icon und Separator-Icon.",
  ...
  },
  {
    ...
    desc: "Dezenter Verlauf von der eigenen Kartenfarbe zu einem leichten Schwarzschleier statt flacher Flaeche. Deckt ab: native HA-Karten sowie Bubble Cards Container und Button-Karten. Bubbles eigene Fuellfarbe wird dafuer neutralisiert, damit der Verlauf im Ein-Zustand nicht verdeckt wird.",
  ...
  },
  {
    ...
    desc: "Weicher, farbiger Leuchtschatten in der Akzentfarbe. Deckt ab: native HA-Karten sowie Bubble Card auf Karten-, Button-, Sub-Button- und Footer-Ebene - Sub-Buttons bekommen einen dezenteren Schein als die Karte selbst.",
  ...
  },
  {
    ...
    desc: "Duenner, akzentfarbener Rahmen mit innerer Leuchtkante. Deckt ab: native HA-Karten sowie Bubble Cards Rahmenvariablen, Container und Sub-Buttons.",
  ...
  },
  {
    ...
    desc: "Milchiges Glas mit Weichzeichner statt blickdichter Kartenfarbe. Deckt ab: native HA-Karten sowie Bubble Cards Karten-, Haupt- und Sub-Button-Hintergruende. Wirkt am staerksten auf einem Dashboard mit Hintergrundbild.",
    css: "ha-card {\n  background: rgba(255, 255, 255, 0.10) !important;\n  backdrop-filter: blur(16px) saturate(160%);\n  -webkit-backdrop-filter: blur(16px) saturate(160%);\n  border: 1px solid rgba(255, 255, 255, 0.25) !important;\n  --bubble-card-background-color: rgba(255, 255, 255, 0.10);\n  --bubble-main-buttons-background-color: rgba(255, 255, 255, 0.10);\n  --bubble-button-background-color: transparent;\n  --bubble-sub-button-background-color: rgba(255, 255, 255, 0.14);\n}\n.bubble-container {\n  background: rgba(255, 255, 255, 0.10) !important;\n  backdrop-filter: blur(16px) saturate(160%);\n  -webkit-backdrop-filter: blur(16px) saturate(160%);\n  -webkit-mask-image: -webkit-radial-gradient(white, black);\n}",
  },
  {
    id: "relief-tiefe",
    label: "Relief: Weiche Tiefenwirkung",
    desc: "Mehrschichtiger Schatten (aussen weich, oben eine feine Glanzkante) laesst Karten leicht erhaben wirken. Deckt ab: native HA-Karten sowie Bubble Cards Karten-, Button- und Sub-Button-Ebene.",
