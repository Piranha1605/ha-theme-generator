    ...
    this.shadowRoot.innerHTML = `
      <style>
        ...
        * { box-sizing: border-box; }
        ...
        .editing-surface-dark .field-section-tag { color: #79dba0; }
        ...
        .field-section-tag { font-family: -apple-system, sans-serif; color: #5fd991; font-size: 10px; white-space: nowrap; }
