...
const HATG_TEXTE = {
  ...
  "Einstellungsseiten: größere Icon-Kacheln": "Settings pages: larger icon tiles",
...
.mdc-top-app-bar {
  ...
  },
  {
    ...
    label: "Einstellungsseiten: größere Icon-Kacheln",
    desc: "Vergrößert die farbigen Kacheln vor jedem Eintrag und rückt Überschrift und Untertitel enger zusammen. Greift auf Elemente innerhalb der Liste zu und braucht deshalb Shadow-DOM-Pfade - sollte das Frontend die Liste umbauen, muss der Pfad nachgezogen werden. Prüfen lässt er sich in der Browser-Konsole mit uix_tree($0).",
    ziel: "uix-config-yaml",
    css: `ha-config-navigation-list $: |
  .icon-background {
    width: 42px;
    height: 42px;
    display: flex;
