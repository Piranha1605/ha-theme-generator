...
uix:
  style: |
    ha-card {
      ...
      ziele2:
        "Reicht ein einfacher CSS-Block nicht, weil du tiefer ins Shadow DOM musst, gibt es zu jedem Ziel die Variante mit <code>-yaml</code> am Ende, etwa <code>uix-card-yaml</code>. Die trägst du im Freitextfeld \"Eigene Theme-Einträge\" ein.",
...
uix:
  style: |
    ha-card {
      ...
      ziele2:
        "When a plain CSS block is not enough because you need to go deeper into the shadow DOM, every target also has a variant ending in <code>-yaml</code>, for example <code>uix-card-yaml</code>. You enter those in the free-text field \"Your own theme entries\".",
