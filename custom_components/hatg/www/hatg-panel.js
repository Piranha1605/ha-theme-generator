...
ha-list-item-button::before {
  ...
  },
  {
    ...
    ziel: "uix-drawer",
    css: `.mdc-drawer {
  background-color: rgba(28, 28, 30, 0.55) !important;
...
.mdc-top-app-bar {
  background: rgba(28, 28, 30, 0.55) !important;
  background: color-mix(in srgb, var(--app-header-background-color, var(--primary-background-color)) 55%, transparent) !important;
