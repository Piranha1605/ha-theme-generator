...
const HATG_CARDMOD_TEMPLATES = [
  {
    ...
    desc: "Icons bekommen einen runden, halbtransparenten Hintergrund-Chip in der Theme-Akzentfarbe statt einer nackten Glyphe. Setzt zusaetzlich die Bubble-Card-Icon-Variablen, die als CSS-Custom-Properties auch in verschachteltes Shadow-DOM durchsickern.",
  ...
  },
  {
    ...
    desc: "Jede Karte bekommt statt einer flachen Flaeche einen dezenten Verlauf von der eigenen Kartenfarbe zu einem leichten Schwarzschleier - wirkt raeumlicher, ohne die Grundfarbe zu veraendern.",
  ...
  },
  {
    ...
    desc: "Weicher, farbiger Leuchtschatten in der Akzentfarbe rund um jede Karte statt eines neutralen Standard-Schattens.",
  ...
  },
  {
    ...
    desc: "Duenner, akzentfarbener Rahmen mit leichter innerer Leuchtkante statt einer neutralen Standardkante - hebt jede Karte klar vom Hintergrund ab.",
  ...
  },
  {
    ...
    desc: "Milchiges, angehauchtes Glas mit Weichzeichner-Unschaerfe statt blickdichter Kartenfarbe - global auf jeder Karte statt nur in einer einzelnen.",
    css: "ha-card {\n  background: rgba(255, 255, 255, 0.10) !important;\n  backdrop-filter: blur(16px) saturate(160%);\n  -webkit-backdrop-filter: blur(16px) saturate(160%);\n  border: 1px solid rgba(255, 255, 255, 0.25) !important;\n}",
  },
  {
    id: "relief-tiefe",
    label: "Relief: Weiche Tiefenwirkung",
    desc: "Mehrschichtiger Schatten (aussen weich, innen eine feine Glanzkante oben) laesst jede Karte leicht erhaben statt flach wirken.",
