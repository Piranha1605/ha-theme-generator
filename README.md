...
## Aktuelle Version: 1.12.4

Diese Version ist die neue saubere Basis nach dem Neustart des Projekts.

## Aktueller Funktionsumfang

- HACS-Installation funktioniert
- Integration startet sauber
- Seitenleistenpunkt wird angezeigt
- Panel wird korrekt geladen
...
Diese Funktionen werden Schritt für Schritt wieder eingebaut.
...
### Später
Optische Bearbeitung von Farben, Karten, Sidebar, Mushroom, Bubble Card und card-mod.
